...
insert into profiles (user_id, slug, program, pitch, tags, open_to_team, open_to_friends, template, site_url, links, content, published) values
  ('00000000-0000-4000-9000-000000000001', 'yizhou',   'Master of IT · 2 年级',                     '做过两个上线的小程序，最近在学 Rust。想找人一起做校园工具。',        '{React,Node,TypeScript}', true,  true,  'dev',     null, '[]', '{"about": "MIT 二年级，白天写 React，晚上写 Rust。喜欢把校园里的小麻烦做成小工具。", "works": [{"title": "campus-swap", "description": "二手教材交换小程序，Taro + Supabase，30 个种子用户", "url": "https://github.com/", "image": null}, {"title": "timetable-cli", "description": "把课表导出成 ics 的命令行工具", "url": "https://github.com/", "image": null}, {"title": "wall-bot", "description": "墨大墙活动提醒机器人", "url": null, "image": null}]}', true),
  ('00000000-0000-4000-9000-000000000002', 'chloewen', 'Bachelor of Design · 3 年级',               '品牌与包装方向，作品集刚重做一遍，欢迎来挑刺。',                  '{Figma,插画,UI}',         true,  true,  'gallery', null, '[]', '{"about": "做品牌和包装，偶尔画插画。作品集刚重做，欢迎来挑刺。", "works": [{"title": "01 品牌", "description": "校园咖啡车的整套视觉", "url": null, "image": null}, {"title": "02 包装", "description": "茶叶礼盒，三款口味三套配色", "url": null, "image": null}, {"title": "03 海报", "description": "社团招新海报系列", "url": null, "image": null}, {"title": "04 插画", "description": "墨尔本冬天的电车", "url": null, "image": null}]}', true),
  ('00000000-0000-4000-9000-000000000003', 'siyuan',   'BSc Data Science · 2 年级',                 'Kaggle 铜牌一枚。会画图会讲故事，缺一个前端搭档。',               '{Python,数据分析,SQL}',    true,  false, 'cv',      null, '[]', '{"about": "数据科学二年级，Kaggle 铜牌。会画图会讲故事，缺一个前端搭档。", "works": [{"title": "校园活动数据看板", "description": "墨大墙活动数据可视化，Python + D3", "url": null, "image": null}, {"title": "Kaggle · Tabular Playground", "description": "铜牌方案，LightGBM + 特征工程", "url": "https://www.kaggle.com/", "image": null}]}', true),
